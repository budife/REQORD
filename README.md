...
- Setiap tabel request memiliki kolom `Catatan`; note bisa dibuka dengan klik pada isi catatan atau Title yang memiliki note, lalu diedit dari modal Edit work order.
